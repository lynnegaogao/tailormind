    ...
    def files(self, request):
        ...
        if files:
            ...
            #         print(key, value)
                ...
                # TODO 请求openai api获取file structure
                # 示例数据
                sample = {
                ...
                # 默认值
                file_openai_response = sample
                # 调用openAI.py的get_file_structure函数
                # file_openai_response=self.get_file_structure(file_path)
                fileStructure = file_openai_response['file_structure']
                fileSummary=file_openai_response['overview']+file_openai_response['summary']
