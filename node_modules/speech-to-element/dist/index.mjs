...
class L {
  static extract(t, e, i) {
    ...
    for (let n = t.resultIndex; n < t.results.length; ++n) {
      ...
      i && (s = b.translate(s, i)), t.results[n].isFinal ? e += s : r += s;
    }
...
class u {
  ...
  static setText(t, e, i, r) {
    u.toggleCommandModeOff(t), f.isPrimitiveElement(r) ? (r.value = i, t.isTargetInShadow || d.setOffsetForPrimitive(r, i.length, !0), T.IS_SAFARI() && t.autoScroll && m.scrollSafariPrimitiveToEnd(r)) : (r.textContent = i, t.isTargetInShadow || d.focusEndOfGeneric(r), setTimeout(() => m.scrollGeneric(t, r))), t.resetRecording(e);
  }
  ...
  static execCommand(t, e, i, r, n) {
    ...
    if (!s || !r || !i)
      return;
    const o = ((E = s.settings) == null ? void 0 : E.caseSensitive) === !0 ? e : e.toLowerCase(), c = l.breakupIntoWordsArr(o), h = ((C = s.settings) == null ? void 0 : C.substrings) === !1 ? u.checkIfMatchesWord : u.checkIfMatchesSubstring;
    ...
    if (!(s.commandMode && !t.isWaitingForCommand)) {
      ...
      if (s.resume && h(s.resume, o, c))
        return t.isPaused = !1, (y = t.onPauseTrigger) == null || y.call(t, !1), u.toggleCommandModeOff(t), t.resetRecording(i), { doNotProcessTranscription: !0 };
...
class S {
  ...
  static setState(t, e) {
    document.activeElement === e && (f.isPrimitiveElement(e) ? S.setStateForPrimitive(t, e) : S.setStateForGeneric(t, e));
  }
...
class v {
  ...
  static setStateForGenericElement(t, e) {
    ...
    if (document.activeElement === e) {
      ...
      if (o != null && o.focusNode) {
        const c = d.getGenericElementCursorOffset(e, o, !0), h = (r = e.textContent) == null ? void 0 : r[c - 1], E = d.getGenericElementCursorOffset(e, o, !1), C = (n = e.textContent) == null ? void 0 : n[E];
        l.isCharDefined(h) && (t.startPadding = " "), l.isCharDefined(C) && (t.endPadding = " "), t.isCursorAtEnd = ((s = e.textContent) == null ? void 0 : s.length) === E;
        return;
      }
    }
  ...
  static setState(t, e) {
    f.isPrimitiveElement(e) ? v.setStateForPrimitiveElement(t, e) : v.setStateForGenericElement(t, e);
  }
...
class k {
  ...
  prepare(t) {
    v.setState(this, t), S.setState(this, t), this.isTargetInShadow = f.isInsideShadowDOM(t), f.isPrimitiveElement(t) ? (this._primitiveElement = t, this._originalText = this._primitiveElement.value) : (this._genericElement = t, this._originalText = this._genericElement.textContent);
  }
  ...
  updateElements(t, e, i) {
    ...
    if (this.finalTranscript === r && t === "")
      return;
    p.process(this, i, t === "", this._onPreResult, this._options) && (t = "", i = "");
  ...
  updatePrimitiveElement(t, e, i) {
    this.isHighlighted && S.removeForPrimitive(this, t), this.primitiveTextRecorded || v.adjustStateAfterRecodingPrimitiveElement(this, t), i && v.adjustSateForNoTextPrimitiveElement(this);
    ...
    this.autoScroll && T.IS_SAFARI() && this.isCursorAtEnd && m.scrollSafariPrimitiveToEnd(t);
  }
  updateGenericElement(t, e, i) {
    this.isHighlighted && S.removeForGeneric(this, t), this.spansPopulated || f.appendSpans(this, t);
  ...
  finalise(t) {
    this._genericElement && (t ? (this.finalSpan = f.createGenericSpan(), this.setInterimColorToFinal(), this.interimSpan = f.createInterimSpan(), this.scrollingSpan = f.createGenericSpan()) : this._genericElement.textContent = this._genericElement.textContent, this.spansPopulated = !1), F.remove(this);
  }
...
class w extends k {
  ...
  start(t) {
    var e;
    this._extractText === void 0 && (this._extractText = T.IS_SAFARI() ? L.extractSafari : L.extract), this.validate() && (this.prepareBeforeStart(t), this.instantiateService(t), (e = this._service) == null || e.start(), this._translations = t == null ? void 0 : t.translations);
  }
  validate() {
    return w.getAPI() ? !0 : (this.error("Speech Recognition is unsupported"), !1);
  }
  ...
  setEvents() {
    this._service && (this._service.onstart = () => {
      ...
      T.IS_SAFARI() && t.message === "Another request is started" || t.error === "aborted" && this.isRestarting || t.error !== "no-speech" && this.error(t.message || t.error);
...
const O = "https://github.com/OvidijusParsiunas/speech-to-element";
class I {
  static validateOptions(t, e) {
    return e ? !e.subscriptionKey && !e.token && !e.retrieveToken ? (t(`Please define a 'subscriptionKey', 'token' or 'retrieveToken' property - more info: ${O}`), !1) : e.region ? !0 : (t(`Please define a 'region' property - more info: ${O}`), !1) : (t(`Please provide subscription details - more info: ${O}`), !1);
  }
  ...
  static async get(t, e) {
    const i = await I.getNewSpeechConfig(t, e);
    return i && I.process(i, e), i;
  }
}
const N = class {
  // 20s
  ...
  static reset(a, t) {
    a.stopTimeoutMS = t || N.DEFAULT_MS, a.stopTimeout && clearTimeout(a.stopTimeout), N.set(a);
  }
};
let R = N;
R.DEFAULT_MS = 2e4;
class D {
  ...
  static extract(t, e, i, r) {
    return r && (t = b.translate(t, r)), i ? { interimTranscript: "", finalTranscript: e + t, newText: t } : { interimTranscript: t, finalTranscript: e, newText: t };
  }
}
class A extends k {
  constructor() {
  ...
  start(t) {
    this._newTextPadding = "", this.stopTimeout === void 0 && R.reset(this, t == null ? void 0 : t.stopAfterSilenceMs), this.prepareBeforeStart(t), this.startAsync(t);
  }
  async startAsync(t) {
    var e;
  ...
  validate(t) {
    return A.getAPI() ? I.validateOptions(this.error.bind(this), t) : (this.moduleNotFound(), !1);
  }
  async instantiateService(t) {
    const e = A.getAPI(), i = e.AudioConfig.fromDefaultMicrophoneInput(), r = await I.get(e.SpeechConfig, t);
    if (r) {
  ...
  onRecognizing(t, e) {
    if (this._stopping)
      return;
    const { interimTranscript: i, finalTranscript: r, newText: n } = D.extract(
    ...
    switch (i.reason) {
      ...
      case window.SpeechSDK.ResultReason.RecognizedSpeech:
        if (i.text && !this._stopping) {
          const { interimTranscript: r, finalTranscript: n, newText: s } = D.extract(
...
class _ {
  static toggle(t, e) {
    ...
    (r = this._service) != null && r.recognizing ? this._service.stop() : i === "webspeech" ? _.startWebSpeech(e) : i === "azure" ? _.startAzure(e) : (console.error("service not found - must be either 'webspeech' or 'azure'"), (n = e == null ? void 0 : e.onError) == null || n.call(e, "service not found - must be either 'webspeech' or 'azure'"));
  }
  static startWebSpeech(t) {
    _.stop(), this._service = new w(), this._service.start(t);
  }
  static isWebSpeechSupported() {
    return !!w.getAPI();
  }
  static startAzure(t) {
    _.stop(), this._service = new A(), this._service.start(t);
  }
  static stop() {
    var t;
