                ...
                <div id="chat-view" class="module-block">
                    ...
                    <div class="module-component">
                        <chat @getFileData="onGetFileData" :nodeToQuestionRmd="nodeToQuestionRmd"
                            :getFileStatus="getFileStatus" @changeMindmapToDefault="onChangeMindmapToDefault" />
                    </div>
                </div>
                <!-- 文件上传 -->
...
export default {
    ...
    methods: {
        ...
        onGenerateCustomizedNote() {
            DataService.getCustomizedNote((note) => {
                this.customizedNote = note;
            })
        },
