...
//     }>(),
//     {
//         options: {} // Provide a default value for options object if not passed from parent component
//     },
// )
...
// const series = merge({}, defaultSeries[0])
...
const defaultOptions = {
    series: [{
         ...
         * 例：{
            ...
            */
        data: [
             { name: "卡尔曼滤波器算法", value: 300 },
            { name: "线性二次调节", value: 200 },
            { name: "高斯随机向量", value: 200 },
            { name: "预测步骤", value: 100 },
            { name: "更新步骤", value: 100 },
            { name: "卡尔曼增益", value: 100 },
            { name: "最优控制策略", value: 100 },
            { name: "动态规划", value: 100 },
            { name: "正规线性二次调节算法", value: 100 },
            { name: "高斯分布", value: 300 },
            { name: "LQR更新", value: 100 }
        ]
    }]
};
...
function DrawWordCloud() {
    const mychart = echarts.init(document.getElementById("charts-content"));// 可以设置主题色'dark'
    mychart.setOption({
